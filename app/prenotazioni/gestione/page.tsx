    ...
    async function loadBookings() {
      try {
        ...
        if (response.ok) {
          ...
          setLoadError(true)
          showToast('error', 'Errore nel caricamento delle prenotazioni. Riprova più tardi.')
        }
      } catch (error) {
        console.error('Errore nel caricamento delle prenotazioni:', error)
        setLoadError(true)
        showToast('error', 'Impossibile caricare le prenotazioni. Controlla la connessione.')
      } finally {
        setLoading(false)
      }
    }
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        {bookings.length === 0 && !loadError ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-red-500 text-lg mb-4">Errore nel caricamento delle prenotazioni</p>
            <button 
